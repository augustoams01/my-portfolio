...
export const HeroOrbit = ({children, size, rotation, shouldSpin = false, spinDuration,  orbitDuration, shouldOrbit = false}: PropsWithChildren<{size: number, rotation: number,spinDuration?: string, shouldSpin?: boolean, orbitDuration?: string, shouldOrbit?: boolean}>) =>{
    return(
