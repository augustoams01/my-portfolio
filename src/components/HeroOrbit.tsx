...
export const HeroOrbit = ({children, size, rotation, shouldSpin, spinDuration,  orbitDuration, shouldOrbit}: PropsWithChildren<{size: number, rotation: number,spinDuration?: string, shouldSpin?: boolean, orbitDuration?: string, shouldOrbit?: boolean}>) =>{
    return(
