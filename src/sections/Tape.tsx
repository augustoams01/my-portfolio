...
export const TapeSection = () => {
  return (
    <div className="py-16 lg:py-24 overflow-x-clip" >
        ...
        <div className="bg-gradient-to-r -mb-10 to-emerald-300  from-sky-400 opacity-40  rotate-6 -mx-1">
        ...
        <div className="bg-gradient-to-r to-emerald-300 from-sky-400  -rotate-3 -mx-1">
          <div className="flex [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]"          >
